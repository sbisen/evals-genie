...
**Ground Truth:** "Calculate (Q4_2024_revenue - Q4_2023_revenue) / Q4_2023_revenue * 100"

**Agent Answer:** (Generated by Gemini)
"To calculate the year-over-year growth rate for Q4, we need to compare Q4 2024 revenue with Q4 2023 revenue using the formula: ((Current Period - Previous Period) / Previous Period) × 100"
...
1. Navigate to the Test Sets (GT) section in the frontend
